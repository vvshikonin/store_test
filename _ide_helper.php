...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getOrder($externalID)
        {
                        /** @var \App\Services\RetailCRMService $instance */
                        return $instance->getOrder($externalID);
        }
                    /**
         ...
         * @static 
         */ 
        public static function destroyOrder()
        {
                        /** @var \App\Services\RetailCRMService $instance */
                        return $instance->destroyOrder();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function removeKeyFromObject($object, $keyToClear)
        {
                        /** @var \App\Services\RetailCRMService $instance */
                        return $instance->removeKeyFromObject($object, $keyToClear);
        }
...
namespace  { 
            ...
            class RetailCRM extends \App\Facades\RetailCRM {}
